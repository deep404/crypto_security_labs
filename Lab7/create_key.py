...
with MongoClient("mongodb+srv://moglanmihai:Zm9I5JR0YKYukEGW@cluster0.quxiy.mongodb.net/myFirstDatabase?retryWrites=true&w=majority", auto_encryption_opts=csfle_opts) as client:
